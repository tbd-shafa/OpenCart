...
class Order extends \Opencart\System\Engine\Model {
	 ...
	 * @return int
	 */
	public function addOrder(array $data ,array $selected_colors): int {
		...
		if (isset($data['products'])) {
			...
			foreach ($data['products'] as $product) {
				...
				// Retrieve the color for this product from the $selected_colors array
				$color = isset($selected_colors[$product['cart_id']]) ? $this->db->escape($selected_colors[$product['cart_id']]) : '';
