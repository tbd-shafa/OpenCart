    ...
    \$.ajax({
        ...
        echo "\" target=\"_blank\">' + product['subscription'] + '</small>';
                    ...
                    html += '  <td class=\"text-end\">' + product['total'] + '</td>';
                     html += '  <td class=\"text-end\">' + product['custom_color'] + '</td>';
